    ...
    if (t.isVariableDeclaration(declaration)) {
        ...
        for (const declarator of declarators) {
            if (declarator.init &&
                ...
                if (typeParameters) {
                    (0, errawr_1.invariant)((typeParameters === null || typeParameters === void 0 ? void 0 : typeParameters.type) === 'TSTypeParameterDeclaration', 'Invalid type parameters');
                }
                (0, errawr_1.invariant)((returnType === null || returnType === void 0 ? void 0 : returnType.type) === 'TSTypeAnnotation', 'Invalid return type annotation');
                ...
                declarator.id.typeAnnotation = t.tsTypeAnnotation(t.tsFunctionType(typeParameters, params_, returnType));
            }
            ...
            for (const name of queue) {
                ...
                (_c = boundPath.parentPath) === null || _c === void 0 ? void 0 : _c.traverse({
                    Identifier(path) {
                        ...
                        if ((t.isTSQualifiedName(parentNode) && parentNode.left !== node) ||
                            t.isImportSpecifier(parentNode) ||
                            t.isImportDefaultSpecifier(parentNode)) {
                            return;
                        }
                        const { name } = node;
                        if (((_b = (_a = tScope.getTypeBinding(path, name)) === null || _a === void 0 ? void 0 : _a.path) === null || _b === void 0 ? void 0 : _b.scope) === moduleScope ||
                            ((_c = path.scope.getBinding(name)) === null || _c === void 0 ? void 0 : _c.scope) === moduleScope) {
                            queue.push(name);
                        }
                    },
                    // @ts-ignore
