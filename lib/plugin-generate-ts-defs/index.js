    ...
    if (t.isVariableDeclaration(declaration)) {
        ...
        for (const declarator of declarators) {
            if (declarator.init &&
                ...
                (0, errawr_1.invariant)(returnType_.type === 'TSTypeAnnotation', 'Invalid return type annotation');
                ...
                declarator.id.typeAnnotation = t.tsTypeAnnotation(t.tsFunctionType(typeParameters, params_, returnType_));
            }
