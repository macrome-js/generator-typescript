    ...
    const visitor = {
        Program(path) {
            ...
            const exportedNames = body
                ...
                .flatMap((node) => Object.keys((0, get_binding_identifiers_1.default)(node)));
            ...
            for (const name of queue) {
                ...
                (_c = boundPath.parentPath) === null || _c === void 0 ? void 0 : _c.traverse({
                    TSTypeReference(path) {
                        ...
                        if (((_a = boundPath.scope.getBinding(name)) === null || _a === void 0 ? void 0 : _a.scope) === moduleScope && !usedSet.has(name)) {
                            queue.push(name);
                        }
                    },
                    TSTypeQuery(path) {
